...
public class Log {
	...
	//Not sure if this is right, comment it out if it is wrong
    public static void finish() {
	if(curTreeLine.length()>=1) wTreeLn();
    ...
    public static void noteToken() {
		...
		}else if(Scanner.nextToken==nameToken){
	...
	writeLogLine("Binding: "+(useLineNum > 0 ? "Line "+useLineNum+": " : "") + name +" refers to decleration in "+(lineNum>0 ? "line " +lineNum : " The library"));
    }
