...
public class Syntax {
    ...
    public static void init() {
		...
		library.addDecl(new FuncDecl("putchar"));
		library.addDecl(new FuncDecl("putint"));
    ...
    static Term parse() {
		...
		while(isTermOperator(Scanner.curToken)){
			...
			if(outerTermOpr==null){
				outerTermOpr = innerTermOpr;
				innerTerm.firstOpr =outerTermOpr;
			}else{
				outerTermOpr = innerTermOpr;
